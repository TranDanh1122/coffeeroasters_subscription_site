...
export default function Hero({ section }: { section: HeroSection }): React.JSX.Element {
    ...
    return (
        <section className={`container mb:max-w-none text-[#FEFCF7] w-full  rounded-xl bg-radtio
        bg-contain bg-fixed bg-center bg-no-repeat flex justify-start`} style={{ backgroundImage: `url(${bgImage})` }}>
